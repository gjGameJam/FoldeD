...
public class GameManager : MonoBehaviour
{
    ...
    private void SpawnGlidersForRound()
    {
        ...
        for (int i = 0; i < genes.Length; i++)
        {
            ...
            flightCalcs.SetOnDestroyCallback(HandleGliderCrash);
    ...
    private void HandleGliderCrash(GliderFlight glider, string gliderName, float fitnessScore)
    {
        ...
        Destroy(glider.gameObject); //destory glider that glider flight was attached to
